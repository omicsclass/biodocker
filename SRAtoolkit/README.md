# 说明
这个是[组学大讲堂](https://www.omicsclass.com/)提供的:SRAtoolkit and aspera tools to download High-throughput sequencing data
...
## 2.下载镜像
```
docker pull docker.io/omicsclass/SRAtoolkit:latest
```
## 
